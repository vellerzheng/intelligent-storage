package com.mcloud.filelocalbk.util;
...
public class FileUtils {
    ...
    public static String upload(String httpUrl,String username, String filePath){
    ...
    public static void main(String[] args) throws Exception {
       String httpUrl = "http://118.31.60.54:8501/file/upload";
        ...
        System.out.println(upload(httpUrl,"kraft", filePath));
